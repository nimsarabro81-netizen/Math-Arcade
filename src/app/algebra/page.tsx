      ...
      <Dialog open={!isGameStarted} onOpenChange={(isOpen) => !isOpen && isGameStarted && setIsGameStarted(true)}>
        <DialogContent className="sm:max-w-[425px]" onInteractOutside={(e) => e.preventDefault()}>
          <form onSubmit={handleStartGame}>
            <DialogHeader>
              <DialogTitle>Welcome to the Algebra Arena</DialogTitle>
      ...
      <div className="w-full max-w-4xl mx-auto">
        <header className="text-center mb-8">
          ...
          <p className="mt-2 text-lg text-muted-foreground max-w-2xl mx-auto">
            Drag, drop, and combine terms to simplify and factor the expressions!
          </p>
        </header>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-8">
                ...
                <Ranking collectionName="algebraRanks" title="Algebra Leaderboard" />
            </div>
        </div>
      </div>
    </main>
